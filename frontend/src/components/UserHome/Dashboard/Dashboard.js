      ...
      <div className="user-dashboard-wrapper">
        <div className="user-dashboard-main-content">
          ...
          <div className="dropdown-container">
            ...
            <div class="user-dashboard-widget-divider"></div>

            <div class="parent-user-dashboard-project-task-stats">
              <div class="child-user-dashboard-project-task-stats">
                <div class="user-dashboard-project-task-number-container"><svg
                  class="user-dashboard-project-task-number-check-icon" viewBox="0 0 32 32">
                  <path
                  ...
                  <div class="parent-user-dashboard-project-task-number-ticker-container">
                    <div class="child-user-dashboard-project-task-number-ticker-container">
                      <h4
                        class="user-dashboard-project-task-number-ticker">
                        0</h4>
                    </div>
                  </div>
                </div><span class="user-dashboard-project-quick-stats-title">tasks completed</span>
              </div>
            </div>
          </div>
